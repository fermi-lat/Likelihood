...
void ExpMap::run() {
   ...
   formatter.warn() << "Half-degree pixels are a nominal choice for point-source analysis."
		    << "When working on extended sources, the pixel size of the exposure map must be small enough to sample the smallest extended source present in the model." << std::endl;
   promptForParameters();
