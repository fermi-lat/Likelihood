...
void RoiCuts::setCuts() {
// get everything for now...tLims will be reset in ScData::readData
   m_tLimVec.push_back(make_pair(0., HUGE));
...
bool RoiCuts::accept(const Event &event) {
   ...
   if (event.getSeparation(m_roiCenter)*180./M_PI > m_roiRadius)
      acceptEvent = false;
